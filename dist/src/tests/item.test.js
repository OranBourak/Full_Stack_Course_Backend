...
describe("Item test", () => {
    test("Get /item - empty collection", () => __awaiter(void 0, void 0, void 0, function* () {
        const res = yield (0, supertest_1.default)(app).get("/item").set('Authorization', 'Bearer ' + testUser.accessToken);
        expect(res.statusCode).toBe(200);
        const data = res.body;
        expect(data).toEqual([]);
    }));
    test("POST /item", () => __awaiter(void 0, void 0, void 0, function* () {
        const res = yield (0, supertest_1.default)(app).post("/item").send(testPost).set('Authorization', 'Bearer ' + testUser.accessToken);
        expect(res.statusCode).toEqual(201);
        expect(res.body.name).toEqual(testPost.name);
        const res2 = yield (0, supertest_1.default)(app).get("/item").set('Authorization', 'Bearer ' + testUser.accessToken);
    ...
    test("GET /item/:id", () => __awaiter(void 0, void 0, void 0, function* () {
        ...
        const id = data[0]._id;
        const res2 = yield (0, supertest_1.default)(app).get("/item/" + id).set('Authorization', 'Bearer ' + testUser.accessToken);
        expect(res2.statusCode).toEqual(200);
    ...
    test("PUT /item/:id - update item by ID", () => __awaiter(void 0, void 0, void 0, function* () {
        ...
        const res2 = yield (0, supertest_1.default)(app).put("/item/" + id).send(updatedPost).set('Authorization', 'Bearer ' + testUser.accessToken);
        expect(res2.statusCode).toEqual(200);
        const res3 = yield (0, supertest_1.default)(app).get("/item/" + id).set('Authorization', 'Bearer ' + testUser.accessToken);
    ...
    test("Fail GET /item/:id - get item using fake ID", () => __awaiter(void 0, void 0, void 0, function* () {
        ...
        const res1 = yield (0, supertest_1.default)(app).get("/item/" + fakeID).set('Authorization', 'Bearer ' + testUser.accessToken);
    ...
    test("DELETE /item/:id - delete item by ID", () => __awaiter(void 0, void 0, void 0, function* () {
        ...
        const data = res.body;
        const id = data[0]._id;
        const res2 = yield (0, supertest_1.default)(app).delete("/item/" + id).set('Authorization', 'Bearer ' + testUser.accessToken);
        expect(res2.statusCode).toEqual(200);
        const res3 = yield (0, supertest_1.default)(app).get("/item/" + id).set('Authorization', 'Bearer ' + testUser.accessToken);
